pro aia_teem_map,fileset,fov,wave_,npix,teem_table,vers
;+
; Project     : AIA/SDO
;
; Name        : AIA_TEMPMAP 
...
;
; Syntax      : IDL>aia_teem_map,fileset,fov,wave_,npix,teem_table,vers
;
; Inputs      : fileset  = common filename part of 6 wavelength FITS images
;		wave_	 = strarr(6) with wavelengths in Angstroem
;		fov[4]	 = field-of-view [x1,y1,x2,y2] in solar radii
...
;		16-oct-2013, aiadir  ='/archive/sdo/AIA/lev1/2011/02/15/H0000/'
;
; Contact     : aschwanden@lmsal.com
;-

;_________________________________________________________________________
aiadir  ='/archive/sdo/AIA/lev1/2011/02/15/H0000/'
...
for iw=0,nwave-1 do begin
 searchstring=aiadir+fileset+'*'+wave_[iw]+'.fits'
...
texp_	=fltarr(nwave)
for iw=0,nwave-1 do begin
 read_sdo,files[iw],index0,data0
...
save,filename=teem_map,te_map,em_map,sig_map,chi_map,temperature_map,$

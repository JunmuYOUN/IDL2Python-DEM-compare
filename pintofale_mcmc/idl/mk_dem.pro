...
;	sloop=sloop,xcur=xcur,ycur=ycur,weight=weight,/gauss,$
;	verbose=verbose)
;
;description
...
case code of
  ...
  'cu': begin					;(cursor selection
    ...
    while go_on do begin			;{endless loop to mark points
      ;	click and/or drag
      cursor,x0,y0,/down,/data & mbutton=!err & cursor,x1,y1,/up,/data
      ;	drag?
